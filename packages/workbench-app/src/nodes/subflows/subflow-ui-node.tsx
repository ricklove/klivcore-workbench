...
export const subflowUiNodeType: WorkflowRuntimeNodeTypeDefinition = {
  type: WorkflowBrandedTypes.typeName(`subflow-ui`),
  getComponent: () => ({
    Component: NodeStandardContainer(SubflowUiComponent),
  }),
  inputs: [],
  outputs: [],
  execute: async () => {
...
export const SubflowUiComponent = (
  ...
  return (
    <div className="w-full h-full text-white border-none outline-none resize-none nowheel nodrag nopan bg-black/25 flex items-center justify-center">
      <span className="text-sm text-gray-400">Subflow UI</span>
    </div>
  );
};
